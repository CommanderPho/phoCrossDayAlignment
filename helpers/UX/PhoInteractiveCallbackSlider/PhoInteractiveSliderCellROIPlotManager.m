classdef PhoInteractiveSliderCellROIPlotManager < PhoInteractiveCallbackSliderBase

    properties
      cellRoiValues
      plot_manager_cellRoiPlot
...
%       active_plots_config
   ...
   methods (Access = protected)
		...
		function obj = PhoInteractiveSliderCellROIPlotManager(iscInfo, plot_manager_cellRoiPlot, cellRoiSliderValues)
...
%                     out_buttons{btnIndex}.Value = true;
	...
	methods (Static, Access = public)
		...
		function singleObj = getInstance(iscInfo, plot_manager_cellRoiPlot, sliderValues)
				...
				if does_extant_instance_exist
					...
					if isvalid(extant_instance_obj)
                        ...
                        if isvalid(extant_instance_obj.SliderControllerFigure) 
                            fprintf('returning extant PhoInteractiveSliderCellROIPlotManager instance with id: %s\n', iscInfo.slider_identifier);
			...
			if needs_instance_initialization
				...
				fprintf('Initializing NEW PhoInteractiveSliderCellROIPlotManager instance with id: %s\n', iscInfo.slider_identifier);
				singleObj = PhoInteractiveSliderCellROIPlotManager(iscInfo, plot_manager_cellRoiPlot, sliderValues);
