...
%   Detailed explanation goes here
    ...
    currSessionData.ephysData = pfaAppendSuite2p_v2(currSessionData.ephysData, curr_output_fAll.F, curr_output_fAll.Fneu, curr_output_fAll.iscell, curr_output_fAll.stat, trialLength);
